...
int main() {
  printf("-----------------------------------------------------------------------------------------------------\n");
  printf("---------------Welcome to this 'C-SCAN' OS-Lab Program by Chiranjeet Singh under DR. DEEPA K.-----------------\n");
  printf("-----------------------------------------------------------------------------------------------------\n");
  int i, j, n;
  ...
  if (c == 1) {
    ...
    printf("\nSeek Time (Considering Back Traversal of Head): %d\n", sum+no_t-1);
    printf("Seek Time (Ignoring Back Traversal of Head): %d\n", sum);
  }
